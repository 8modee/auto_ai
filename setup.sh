...
$SUDO chown -R "$(whoami):$(whoami)" "$INSTITUTIO
N_ROOT"
...
CRE
ATE TABLE IF NOT EXISTS agents (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
C
REATE TABLE IF NOT EXISTS founder_checkins (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
INSERT OR IGNORE INTO streams (name, slug, status, autono
my_level, kill_criterion, kill_threshold, kill_metric, kill_window_days) VALUES
