...
PRINCIPLES = {
    ...
    "reality": {
        ...
        "fail_if": "The action is based on untested assumptions presented as facts, or ignores contradictory evidence.",
        "severity": "soft",
    },
    "memory": {
...
REVENUE_RED_LINES = [
    {"id": "R1", "rule": "No illegal income", "keywords": ["illegal", "fraud", "launder", "evade", "black market"]},
...
class ConstitutionalCourt:
    ...
    def audit(self, action: str, agent: str = "unknown",
        ...
        elif overall_result == "PASS" and requires_approval:
            reasoning = (
    ...
    def audit_with_llm(self, action: str, agent: str = "unknown",
        ...
        try:
            ...
            if llm_analysis:
                # Merge LLM findings with rule-based results
    ...
    def get_violation_stats(self) -> dict:
        """Get statistics on constitutional violations for dashboard."""
    ...
    def _check_principle(self, key: str, principle: dict,
        ...
        # ─── SIMPLICITY ───────────────────────────────────────
            ...
            if complex_count >= 3:
                status = "REVIEW_REQUIRED"
                reasoning = f"Multiple complexity indicators ({complex_count}). Ensure simplicity principle is met."
...
6. Transparency: Can this be explained and audited?
