...
class SafetyOfficer(BaseAgent):
    ...
    def run_forever(self):
        ...
        while self._running:
            ...
            try:
                ...
                # Full health check at configured interval
    ...
    def collect_metrics(self) -> Optional[dict]:
        ...
        try:
            ...
            network_tx_mb = round(net_io.bytes_sent / (1024 ** 2), 2)
    ...
    def _record_restart(self, service: str):
        ...
        if service not in self._restart_counts:
            self._restart_counts[service] = []
        self._restart_counts[service].append(time.time())
    ...
    def _check_failover_conditions(self, metrics: Optional[dict], issues: list):
        ...
        if len(critical_issues) >= 2:
            ...
            self._trigger_failover(critical_issues)
    ...
    def _trigger_failover(self, critical_issues: list):
        ...
        # Attempt to notify (would send email/alert in production)
        logger.critical(
    ...
    def _identify_memory_hogs(self):
        ...
        try:
            ...
            if processes:
                ...
                logger.warning(f"Memory hogs: {hog_report}")
    ...
    def _verify_backups(self):
        ...
        if backup_age > timedelta(hours=36):
            logger.warning(f"Latest backup is {backup_age.total_seconds()/3600:.0f} hours old.")
            self.db.log_incident(
                "warning", "backups",
