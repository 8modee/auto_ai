...
class PrintOnDemandAgent(BaseAgent):
    ...
    def run_once(self):
        ...
        if made_this_week >= designs_per_week:
            # Track sales and kill underperformers instead
            self._track_sales()
    ...
    def _generate_design(self, niche: str, style_name: str, style: dict) -> Optional[dict]:
        ...
        concept = self._generate_concept(niche, style_name)
        if not concept:
            return None
...
"""
    ...
    def _fallback_concept(self, niche: str) -> dict:
        ...
        concepts = {
            ...
            "chronic illness awareness": [
                ...
                {"title": "Invisible", "text_lines": ["My illness", "is invisible", "my strength isn't"], "tags": ["chronic", "invisible", "strength"]},
            ],
            "homelab nerds": [
    ...
    def _layout_full_bleed(self, draw: ImageDraw.ImageDraw, text_lines: list,
        ...
        font_size = style["font_size_range"][1] * 3  # Larger for bold statement
        font = self._get_font(font_size)
    ...
    def _kill_underperformers(self):
        """Kill designs that haven't sold after threshold period."""
