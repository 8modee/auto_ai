...
class NewsletterAgent(BaseAgent):
    ...
    def run_once(self):
        ...
        if current_day != send_day:
            # On other days, do subscriber growth tasks
    ...
    def _generate_newsletter(self, stream_cfg: dict) -> Optional[dict]:
...
"""
    ...
    def _check_sponsorship_eligibility(self, stream_cfg: dict):
