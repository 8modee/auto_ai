...
class AffiliateSitesAgent(BaseAgent):
    ...
    def _initialize_affiliate_site(self, site_dir: Path, site_config: dict):
        ...
        hugo_toml = f"""baseURL = "https://{site_config.get('slug', 'affiliate')}.pages.dev/"
languageCode = "en-au"
...
<body>
    ...
    <footer><p>&copy; {{ now.Year }} {{ .Site.Title }}. Prices updated regularly.</p></footer>
</body>
</html>
"""
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    {{ range $index, $element := .Params.products }}
    {
      "@type": "ListItem",
...
.product-cards{display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));gap:1rem;margin:2rem 0}
