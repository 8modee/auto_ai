...
class SocialMediaAgent(BaseAgent):
    ...
    def __init__(self):
        ...
        self.platform_configs = {
            ...
            "linkedin": {
                ...
                "hashtag_limit": 5,
                "best_times": [8, 10, 12],
                "content_style": "professional, insight-driven, story-based",
            },
            "reddit": {
                "max_chars": 40000,
                "hashtag_limit": 0,
    ...
    def run_once(self):
        ...
        return "; ".join(results) if results else "Social media cycle complete"
...
- For Pinterest: keyword-rich description for an infographic or visual
