...
class FreelancePipelineAgent(BaseAgent):
        ...
        try:
            ...
            for card in job_cards[:15]:
                ...
                if link_el:
                    ...
                    link = f"https://www.peopleperhour.com{href}" if href.startswith("/") else href
    ...
    def _calculate_skill_match(self, text: str, skills: list) -> float:
...
- Based in Australia (AEST timezone)
...
"""
    ...
    def _adjust_targeting(self):
        ...
        for lesson in lessons:
            ...
            if "response rate" in lesson_text and "low" in lesson_text:
