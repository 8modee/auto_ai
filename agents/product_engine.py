...
class ProductEngineAgent(BaseAgent):
    ...
    def __init__(self):
        super().__init__()
        se
lf.products_dir = INSTITUTION_ROOT / "products"
    ...
    def run_once(self):
        ...
        if made_this_week >= products_per_week:
            ...
            self._track_sales()
            return f"Weekly quota met ({made_this_week}/{products_per_week}). Tracking 
sales."
 ...
 None
    ...
    def _generate_product(self, product_type: dict, stream_cfg: dict) -> Optional[dict]:
        ...
        if REPORTLAB_AVAILABLE:
            ...
            logger.war
ning("ReportLab unavailable. Skipping PDF generation.")
            return None
    ...
    def _checklist_pages(self, niche: str, pages: int) -> list:
        ...
        pages_list = [{
            ...
            "content": (
                ...
                "PHASE 1: PREPARATION\n"
                "☐ Research requirements and prereq
uisites\n"
