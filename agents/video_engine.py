...
class VideoEngineAgent(BaseAgent):
 ...
 self._ffmpeg_available = self._check_ffmpeg()
    ...
    def run_once(self):
        ...
        audio_path = self._generate_tts(script, script_slug, stream_
cfg)
        if not audio_path:
...
# Parse JSON
        ...
        return {
            ...
            "scenes": [
                ...
                {"text": "Second, cons
istency beats intensity.", "visual_keyword": "daily routine productivity", "duration_seconds": 15},
...
h
    ...
    def _download_pixabay(self, keyword: str, output_path: str, max_duration: int) -> bool:
        """Download a video clip from Pix
abay API."""
...
e = 64
    ...
    def _upload_youtube(self, script: dict, video_path: Path,
        ...
        refresh_token = os.environ.get("YOUTUBE_REFRESH_TO
KEN")
